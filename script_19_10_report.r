...
#################   Second tatra_semplified_V1 .js #############################
# key species Picea abies
#  145 years of model # cz area
...
stitch("D:/iLand.r/script_20_10_report_p2.txt", template=system.file("misc", "knitr-template.Rnw", package="knitr")) 
